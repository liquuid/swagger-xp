...
Swagger UI, generate a beautyfull interface for API and its documentation.

Swagger Codegen, a client/server generator for more than 60 languages,

Main develop aproachs
---------------------
...
1) Design API first ( Contract First )
    ...
    * Paralelize backend and frontend
...
3) Service driven
    ...
    * Needs atention to don't break the API compatibility
...
Swagger Codegen CLI comes with the following option to provide customized templates:
...
Try understand why some developers don't like the code generated by swagger-codegen, like [go-swagger](https://github.com/go-swagger/go-swagger) developer.
