...
module SwaggerClient
  ...
  class Vehicle
    ...
    def valid?
      ...
      vehicle_type_validator = EnumAttributeValidator.new('String', ["motorcycle", "automobile", "tank"])
    ...
    def vehicle_type=(vehicle_type)
      validator = EnumAttributeValidator.new('String', ["motorcycle", "automobile", "tank"])
    ...
    def hash
      [id, user_id, name, photo_urls, vehicle_type].hash
    end
