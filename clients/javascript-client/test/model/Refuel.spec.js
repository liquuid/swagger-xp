...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VehicleMaintanceManager.Refuel();
  });
  ...
  describe('Refuel', function() {
    it('should create an instance of Refuel', function() {
      // uncomment below and update the code to test Refuel
      //var instane = new VehicleMaintanceManager.Refuel();
      //expect(instance).to.be.a(VehicleMaintanceManager.Refuel);
    });
