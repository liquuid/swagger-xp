...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VehicleMaintanceManager.Fine();
  });
  ...
  describe('Fine', function() {
    it('should create an instance of Fine', function() {
      // uncomment below and update the code to test Fine
      //var instane = new VehicleMaintanceManager.Fine();
      //expect(instance).to.be.a(VehicleMaintanceManager.Fine);
    });
