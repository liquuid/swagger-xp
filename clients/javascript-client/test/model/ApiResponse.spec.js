...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VehicleMaintanceManager.ApiResponse();
  });
  ...
  describe('ApiResponse', function() {
    it('should create an instance of ApiResponse', function() {
      ...
      //var instane = new VehicleMaintanceManager.ApiResponse();
      //expect(instance).to.be.a(VehicleMaintanceManager.ApiResponse);
    });
